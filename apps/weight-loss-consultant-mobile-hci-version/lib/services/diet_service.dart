...
class DietService{
  ...
  Map<String, List<DietModel>> _getIntermediateDiets(){
    final _random = Random();
  ...
  Map<String, List<DietModel>> _getAdvancedDiets(){
    final _random = Random();
  ...
  Map<String, List<DietModel>> getTodayDiet(int level){
    switch (level){
      case 1: return _getBeginnerDiets();
      case 2: return _getIntermediateDiets();
      case 3: return _getAdvancedDiets();
    }
