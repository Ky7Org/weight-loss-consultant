...
import 'package:weight_loss_consultant_mobile/pages/trainer/upcoming_training_trainer.dart';
    ...
    switch (settings.name) {
      ...
      case RoutePath.upcomingTrainingPage:
        if (args is PackageModel) {
          return MaterialPageRoute(builder: (_) {
            return UpcomingTrainingPage(
              packageModel: args,
            );
          });
        }
        return _errorRoute();
      case RoutePath.trainerUpcomingPage:
        if (args is CustomerCampaignModel) {
          return MaterialPageRoute(builder: (_) {
            return UpcomingTrainingTrainerPage(
              campaignModel: args,
            );
          });
        }
      ...
      case RoutePath.trainerViewListPackagePage:
        if (args is int) {
          return MaterialPageRoute(builder: (_) {
            return TrainerViewListPackagePage(
              campaignId: args,
            );
          });
        }
      ...
      case RoutePath.customerUpdateCampaignPage:
        if (args is int) {
          return MaterialPageRoute(builder: (_) {
            return CustomerUpdateCampaignPage(
              campaignID: args,
            );
          });
        }
      ...
      case RoutePath.customerAppliedPackagePage:
        if (args is int) {
          return MaterialPageRoute(builder: (_) {
            return CustomerAppliedPackagePage(
              campaignId: args,
            );
          });
        }
      ...
      case RoutePath.trainerUpdatePackagePage:
        if (args is int) {
          return MaterialPageRoute(builder: (_) {
            return TrainerUpdatePackagePage(
              packageId: args,
            );
          });
        }
      ...
      case RoutePath.customerOngoingCampaignPage:
        if (args is int) {
          return MaterialPageRoute(builder: (_) {
            return CustomerOnGoingCampaignPage(
              campaignId: args,
            );
          });
        }
      ...
      case RoutePath.trainerFeedbackReportPage:
        if (args is int) {
          return MaterialPageRoute(builder: (_) {
            return TrainerFeedbackReportPage(
              packageId: args,
            );
          });
        }
      ...
      case RoutePath.customerReportHistoryPage:
        if (args is int) {
          return MaterialPageRoute(builder: (_) {
            return CustomerReportHistoryPage(
              packageId: args,
            );
          });
        }
      ...
      case RoutePath.trainerOnGoingPackageDetailPage:
        if (args is int) {
          return MaterialPageRoute(builder: (_) {
            return TrainerOnGoingPackageDetailPage(
              packageId: args,
            );
          });
        }
      ...
      case RoutePath.trainerReportHistoryPage:
        if (args is int) {
          return MaterialPageRoute(builder: (_) {
            return TrainerReportHistoryPage(
              packageId: args,
            );
          });
        }
