...
class FoodList {
  static var wholeGrainCereal = DietModel(
      ...
      'asset/diet/wholeGrainCereal.jpg',
  ...
  static var blackBeanBurger = DietModel(
      ...
      "asset/diet/blackBeanBurger.jpg",
  ...
  static var waterAndSportsDrink = DietModel(
      ...
      "asset/diet/waterAndSportsDrink.jpg",
  ...
  static List<DietModel> listFood = [
    wholeGrainCereal,
    energyBar,
    grilledChicken,
    blackBeanBurger,
